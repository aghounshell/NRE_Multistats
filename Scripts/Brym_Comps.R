...
brym_graph <- ggarrange(sal,chla,a254,common.legend=TRUE,ncol=2,nrow=2)

ggsave("C:/Users/ahoun/OneDrive/Desktop/NRE_Multistats/Plots/Figure8.jpg",brym_graph,dpi=800,width=250,height=250,
       units=c("mm"))
